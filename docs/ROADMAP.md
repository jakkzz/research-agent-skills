...
- **Literature discovery (`skills/literature-discovery`):** [In Progress] Direct querying of arXiv, Semantic Scholar, and CrossRef APIs with structured JSON/BibTeX outputs ([Issue #7](https://github.com/jakkzz/research-agent-skills/issues/7)).
