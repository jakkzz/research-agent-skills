...
- **Thai academic DOCX formatting (`skills/thai-academic-docx`):** [In Progress] Template-first DOCX generator adhering to Thai academic typography (TH Sarabun New, 1.5 line spacing, Buddhist Era dating, table layouts) ([Issue #9](https://github.com/jakkzz/research-agent-skills/issues/9)).
